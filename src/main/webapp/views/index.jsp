...
<body>
    ...
    <div class="main">
		<div class="container">
			<div class="demo">
				<center>
					<h1>Welcome To <svg xmlns="http://www.w3.org/2000/svg" width="75" height="75" fill="currentColor" class="bi bi-activity" viewBox="0 0 16 16">
						<path fill-rule="evenodd" d="M6 2a.5.5 0 0 1 .47.33L10 12.036l1.53-4.208A.5.5 0 0 1 12 7.5h3.5a.5.5 0 0 1 0 1h-3.15l-1.88 5.17a.5.5 0 0 1-.94 0L6 3.964 4.47 8.171A.5.5 0 0 1 4 8.5H.5a.5.5 0 0 1 0-1h3.15l1.88-5.17A.5.5 0 0 1 6 2Z"/>
					  </svg> Medimax,&nbsp;${uname}</h1>
				</center>
			</div>
				...
				<div class="col">
					<div class="card text-white bg-primary">
						...
						<div class="card-body">
						  ...
						  <center><a href="/booking" class="btn btn-light">Book Appointment</a></center>
						</div>
					  </div>
				</div>
				<div class="col">
					<div class="card text-white bg-primary">
						...
						<div class="card-body">
						  ...
						  <center><a href="/ViewBooking" class="btn btn-light">View Bookings</a></center>
						</div>
					  </div>
				</div>
			</div>
