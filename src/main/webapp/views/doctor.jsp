...
<title>MEDICARE | ADMINISTRATION</title>
</head>
<style>
	ul li {
		display: inline;
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-success navbar-custom">
    ...
    <div class="main">
		<div class="container">
			<div class="demo">
				<center>
					<h1>Welcome To <img src="stethoscope-svgrepo-com.svg" alt="" style="height: 95px;"> Management,&nbsp;Doctor</h1>
				</center>
			</div>
				...
				<div class="col">
					<div class="card text-white bg-success">
						...
						<div class="card-body">
						  ...
						  <center><a href="viewAllBooking" class="btn btn-primary">Manage Bookings</a></center>
						</div>
					  </div>
				</div>
				<div class="col">
					<div class="card text-white bg-success">
						...
						<div class="card-body">
						  ...
						  <center><a href="viewAllUsers" class="btn btn-primary">Manage Users</a></center>
						</div>
					  </div>
				</div>
			</div>
